...
// Destructuramos los primeros valores como semánticos
...
const createProduct = async (args) => {
  ...
  if (!title || !price || !category) {
    ...
    console.log(
      'Example: npm run start POST products "New T-Shirt" 12.99 clothing'
    );
    return;
  }
...
const updateProduct = async (id, args) => {
  ...
  if (!title || !price || !category) {
    ...
    console.log(
      'Example: npm run start PUT products/1 "Updated T-Shirt" 15.99 clothing'
    );
    return;
  }
